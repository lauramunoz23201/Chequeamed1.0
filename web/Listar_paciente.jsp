    ...
    <center>
        <div>
            ...
            <form action="ControladorPaciente" method="POST">
                ...
                <input type="submit" name="accion1" value="Listar">
                <input type="submit" name="accion1" value="Nuevo">
            </form>
        </div>
        <br>
        <div>   
                ...
                <tbody>
                    <c:forEach var="datos1" items="${datos1}"> 	
                        <tr>    
                            ...
                            <td style="text-align: center;">${datos1.getFecha()}</td>  
                            <td style="text-align: center;">
                                <form action="ControladorPaciente" method="POST">
                                    <input type="hidden" name="id" value="${dato.getId()}">
                                    <input type="submit" name="accion1" value="Editar">
                                    <input type="submit" name="accion1" value="Eliminar">
                                </form>
                            </td>
                        </tr>
                    </c:forEach>   
